...
beautiful.init(gears.filesystem.get_themes_dir() .. "b1tc0r3/theme.lua")
...
if autostart then
	for command = 1, #autostartCommands do
		awful.spawn.easy_async_with_shell(autostartCommands[command])
	end
end
-- }}}
...
-- Add theme changer control here
...
globalkeys = gears.table.join(
    ...
    -- Volume Control
    awful.key({ }, "#123", function () awful.spawn.with_shell("pactl set-sink-volume @DEFAULT_SINK@ +5%") end,
              {description = "volume up", group = "volume control" }),
    awful.key({ }, "#122", function () awful.spawn.with_shell("pactl set-sink-volume @DEFAULT_SINK@ -5%") end,
              {description = "volume down", group = "volume control"}),
    awful.key({ }, "#121", function () awful.spawn.with_shell("pactl set-sink-mute @DEFAULT_SINK@ toggle") end,
    ...
    -- Rofi
    awful.key({ modkey },            "r",     function () awful.spawn("rofi -modi 'drun,run,ssh' -show drun")  end,
